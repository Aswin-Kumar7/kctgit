            ...
            <div className="flex items-center gap-3">
              {isAdmin && (
                <button
                  ...
                  className={`hidden md:inline-block text-white/90 hover:text-white transition-colors border-b-2 pb-0.5 ${
                    isActive('/admin') ? 'border-white' : 'border-transparent'
                  }`}
                >
                  Admin
                </button>
              ...
              <button
                onClick={onCartClick}
                className="relative p-3 text-white/90 hover:text-white focus:outline-none"
              >
                ...
                <AnimatePresence>
                  {itemCount > 0 && (
                    <motion.span
                      ...
                      className="absolute -top-1 -right-1 bg-white text-orange-700 text-xs font-bold rounded-full h-6 w-6 flex items-center justify-center shadow"
                    >
                      {itemCount}
                    </motion.span>
                  )}
